...
def handle_what_company_intent(query_result):
    ...
    try:
        ...
        if company == "Tesla":
            ...
            return [
                f"""SpaceX designs, manufactures and launches advanced rockets and spacecraft.
                Like NASA but much, much cooler.\n
                https://api.wolframalpha.com/v1/simple?appid={appID()}&i={company}
                """
            ]
        elif company == "Paypal":
            return [
...
def handle_what_is_crypto_intent(query_result):
    ...
    try:
        ...
        if crypto == "dogecoin":
            ...
            return [f"""It is any form of currency that exists virtually and uses cryptography to secure transactions. 
                    ...
                    https://api.wolframalpha.com/v1/simple?appid={appID()}&i=bit+coin
                    """]
    except:
        return ["My engineers are working on this right now - thanks for talking to Elon Musk Bot"]
